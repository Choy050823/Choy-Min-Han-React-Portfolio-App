...
const Works = () => (
  <>
    ...
    <div className="w-full flex">
      ...
      >
        During my secondary school life, I have created multiple projects which involves a wide spectrum
        of technical skills that I have learnt in these few years. Please feel free to check it out below!
      </motion.p>
    </div>
